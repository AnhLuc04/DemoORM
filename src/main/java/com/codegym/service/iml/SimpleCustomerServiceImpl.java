...
public class SimpleCustomerServiceImpl implements CustomerService {
    ...
    static {
        customers = asList(
                new Customer(autoIncreaseId++, "luc", "101", "T.Hoa"),
                new Customer(autoIncreaseId++, "Thanh", "102", "T.Hoa"),
                new Customer(autoIncreaseId++, "Hoa", "103", "T.Hoa"),
                new Customer(autoIncreaseId++, "Tuan", "104", "T.Hoa"),
                new Customer(autoIncreaseId++, "Tuan", "h105", "T.Hoa")
        );
    }
